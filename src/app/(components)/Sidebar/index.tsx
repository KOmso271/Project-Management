...
import { LockIcon, LucideIcon, Home, X, Briefcase, Search, Settings, User, Users } from 'lucide-react'; // Bỏ Link ở đây
...
const SidebarLink = ({ href, icon: Icon, label }: SidebarLinkProps) => {
    ...
    // Lưu ý: isSidebarCollapsed lấy từ Redux để sau này dùng cho hiệu ứng co bóp
    const isSidebarCollapsed = useAppSelector((state) => state.global.isSidebarCollapsed);
    
    return (
        <Link href={href} className="w-full">
            <div className={`relative flex cursor-pointer items-center gap-3 transition-colors hover:bg-gray-100 dark:hover:bg-gray-700 px-8 py-4 ${
